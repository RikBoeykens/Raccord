...
export { ChooseShootingDayDialog } from "./component/choose-shooting-day-dialog/choose-shooting-day-dialog.component";
export { ChooseShootingDayCrewUnitDialogComponent } from
  "./component/choose-shooting-day-crew-unit-dialog/choose-shooting-day-crew-unit-dialog.component";
...
export { CompletedShootingDaysResolve } from "./service/completed-shooting-days-resolve.service";
export { ShootingDaysResolve } from "./service/shooting-days-resolve.service";
export { ShootingDayResolve } from "./service/shooting-day-resolve.service";

export { ShootingDaySceneHttpService } from "./scenes/service/shooting-day-scene-http.service";