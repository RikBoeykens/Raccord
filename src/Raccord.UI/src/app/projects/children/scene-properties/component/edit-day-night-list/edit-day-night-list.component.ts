...
@Component({
    templateUrl: 'edit-day-night-list.component.html',
})
export class EditDayNightListComponent implements OnInit {
    ...
    getDayNights(){
        this._loadingWrapperService.Load(
            this._dayNightHttpService.getAll(this.project.id),
            (data) => this.dayNights =
                data.map((dayNight) => new DayNightDroppableWrapper(dayNight))
        );
    }
