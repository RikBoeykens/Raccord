...
@Component({
  templateUrl: 'admin-choose-project-and-role-dialog.component.html',
})

export class AdminChooseProjectAndRoleDialogComponent {
  ...
  constructor(
    private _dialogRef: MatDialogRef<AdminChooseProjectAndRoleDialogComponent>,
